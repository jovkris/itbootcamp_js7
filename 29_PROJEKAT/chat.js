class Chatroom{
    constructor(r, u){
        ...
        this.unsub = false; //  false kao signal da je stranica prvi put ucitana
    }
    ...
    getChats(callback){
        ...
        this.unsub = this.chats // sve smestam u unsub i kasnije pozivam kao funkciju
        ...
        .onSnapshot(snapshot =>{
            snapshot.docChanges().forEach(change => {
                ...
                if (change.type == `added`) {
                    callback(change.doc); // ceo dokument da bi mu pristupila id-u
                }
            });
        });
    }
